...
import createImg as ci
import cv2
import unicodedata

#テキストボックス内に５文字までしか入力できないように文字制限
...
def clickColorRow():
    ...
    if(fill_value is None):
        ...
        print(fill_value)
        color_window = ci.Color_Window(400, 400)
...
def clickGrayRow():
    ...
    if(fill_value is None):
        ...
        gray_window = ci.GrayScale_Window(400, 400)

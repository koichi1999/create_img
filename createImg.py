            ...
            if i < row / 2:
                ...
                for j in range(column):
                    if j < column / 2:
                        #print("j", j)
                        #print("flag", flag)
                        #print("column_pos+(fill_area*c)", column+(fill_area*c))
                        #print("column_pos+(fill_area*b)", column+(fill_area*b))
                        #print("c", c)
                        #print("b", b)
    ...
    def create_rowWindow(self, fill_area):
        ...
        for i in range(row):
            if i < row / 2:
                ...
                #print("i", i)
                #print("flag", flag)
                #print("row_pos+(fill_area*c)", row_pos+(fill_area*c))
                #print("row_pos+(fill_area*b)", row_pos+(fill_area*b))
                #print("c", c)
                #print("b", b)
